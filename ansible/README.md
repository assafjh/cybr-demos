...
- [Ansible integration](#ansible-integration)
  ...
  - [Loading Conjur policies](#loading-conjur-policies)
    ...
    - [Conjur Cloud](#conjur-cloud)
      - [Data branch](#data-branch)
        - [Login to Conjur as admin using the CLI](#login-to-conjur-as-admin-using-the-cli-1)
        - [Update data policy](#update-data-policy)
        - [Logout from Conjur](#logout-from-conjur-1)
      - [Ansible branch](#ansible-branch-1)
        - [Login as user ansible-admin01](#login-as-user-ansible-admin01-1)
        - [Load ansible policy](#load-ansible-policy-1)
        - [Populate Conjur variables](#populate-conjur-variables-1)
        - [Logout from Conjur CLI](#logout-from-conjur-cli-1)
  ...
  - [Troubleshooting](#troubleshooting)
    - [On Conjur Cloud, when running the playbook, getting an error from the certificate verification](#on-conjur-cloud-when-running-the-playbook-getting-an-error-from-the-certificate-verification)
      ...
      - [Unset CONJUR\_CERT\_FILE](#unset-conjur_cert_file)
