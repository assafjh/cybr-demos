#!/bin/bash
# This script will enable the Kubernetes Cert Authn in Conjur.
...
$SUDO "$CONTAINER_MGR" exec "$CONTAINER_ID" evoke ca issue -f conjur-follower-k8s-cluster conjur-follower.conjur-followers-cert.svc.cluster.local
